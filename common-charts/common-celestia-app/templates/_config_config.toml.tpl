...
send_rate = {{ .Values.app.config.configtoml.p2p.send_rate }}
recv_rate = {{ .Values.app.config.configtoml.p2p.recv_rate }}
...
max_txs_bytes = {{ .Values.app.config.configtoml.mempool.max_txs_bytes }}
...
max_tx_bytes = {{ .Values.app.config.configtoml.mempool.max_tx_bytes }}
