...
| node.image | object | `{"digest":"","pullPolicy":"IfNotPresent","pullSecrets":[],"registry":"ghcr.io","repository":"celestiaorg/celestia-node","tag":"v0.20.2"}` | image parameters for the image |
...
| node.image.tag | string | `"v0.20.2"` | tag for the image, v0.18.1 by default |
